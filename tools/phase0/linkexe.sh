...
LDFLAGS="$LDFLAGS -Wl,--wrap=HSD_LObjLoadDesc -Wl,--wrap=HSD_WObjLoadDesc"
LDFLAGS="$LDFLAGS -Wl,--wrap=HSD_MObjLoadDesc -Wl,--wrap=HSD_TObjLoadDesc"
LDFLAGS="$LDFLAGS -Wl,--wrap=HSD_TObjAddAnim -Wl,--wrap=HSD_TObjAddAnimAll"
...
# bytes mean.
RENDERER_ONLY="GXInit GXInitTexObj GXSetCopyClear GXSetVtxDesc GXClearVtxDesc GXSetVtxAttrFmt GXSetArray GXSetTexCoordGen2 GXLoadTexMtxImm GXLoadNrmMtxImm"
